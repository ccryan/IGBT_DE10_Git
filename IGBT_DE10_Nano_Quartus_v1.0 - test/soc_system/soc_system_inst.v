	soc_system u0 (
		...
		.i2c_ext_1_sda_in                               (<connected-to-i2c_ext_1_sda_in>),                               //                               i2c_ext_1.sda_in
		.i2c_ext_1_scl_in                               (<connected-to-i2c_ext_1_scl_in>),                               //                                        .scl_in
		.i2c_ext_1_sda_oe                               (<connected-to-i2c_ext_1_sda_oe>),                               //                                        .sda_oe
		.i2c_ext_1_scl_oe                               (<connected-to-i2c_ext_1_scl_oe>),                               //                                        .scl_oe
		...
		.pulse_gpio_pio_external_connection_export      (<connected-to-pulse_gpio_pio_external_connection_export>),      //      pulse_gpio_pio_external_connection.export
		.pulse_length_ch2_para_export                   (<connected-to-pulse_length_ch2_para_export>),                   //                   pulse_length_ch2_para.export
		.pulse_length_ch3_para_export                   (<connected-to-pulse_length_ch3_para_export>),                   //                   pulse_length_ch3_para.export
		.pulse_length_ch4_para_export                   (<connected-to-pulse_length_ch4_para_export>),                   //                   pulse_length_ch4_para.export
		.pulse_length_para_export                       (<connected-to-pulse_length_para_export>),                       //                       pulse_length_para.export
		.pulse_length_pio_0_external_connection_export  (<connected-to-pulse_length_pio_0_external_connection_export>),  //  pulse_length_pio_0_external_connection.export
		.pulse_length_pio_10_external_connection_export (<connected-to-pulse_length_pio_10_external_connection_export>), // pulse_length_pio_10_external_connection.export
		.pulse_length_pio_11_external_connection_export (<connected-to-pulse_length_pio_11_external_connection_export>), // pulse_length_pio_11_external_connection.export
		.pulse_length_pio_12_external_connection_export (<connected-to-pulse_length_pio_12_external_connection_export>), // pulse_length_pio_12_external_connection.export
		.pulse_length_pio_13_external_connection_export (<connected-to-pulse_length_pio_13_external_connection_export>), // pulse_length_pio_13_external_connection.export
		.pulse_length_pio_14_external_connection_export (<connected-to-pulse_length_pio_14_external_connection_export>), // pulse_length_pio_14_external_connection.export
		.pulse_length_pio_15_external_connection_export (<connected-to-pulse_length_pio_15_external_connection_export>), // pulse_length_pio_15_external_connection.export
		.pulse_length_pio_16_external_connection_export (<connected-to-pulse_length_pio_16_external_connection_export>), // pulse_length_pio_16_external_connection.export
		.pulse_length_pio_17_external_connection_export (<connected-to-pulse_length_pio_17_external_connection_export>), // pulse_length_pio_17_external_connection.export
		.pulse_length_pio_18_external_connection_export (<connected-to-pulse_length_pio_18_external_connection_export>), // pulse_length_pio_18_external_connection.export
		.pulse_length_pio_19_external_connection_export (<connected-to-pulse_length_pio_19_external_connection_export>), // pulse_length_pio_19_external_connection.export
		.pulse_length_pio_1_external_connection_export  (<connected-to-pulse_length_pio_1_external_connection_export>),  //  pulse_length_pio_1_external_connection.export
		.pulse_length_pio_20_external_connection_export (<connected-to-pulse_length_pio_20_external_connection_export>), // pulse_length_pio_20_external_connection.export
		.pulse_length_pio_21_external_connection_export (<connected-to-pulse_length_pio_21_external_connection_export>), // pulse_length_pio_21_external_connection.export
		.pulse_length_pio_22_external_connection_export (<connected-to-pulse_length_pio_22_external_connection_export>), // pulse_length_pio_22_external_connection.export
		.pulse_length_pio_23_external_connection_export (<connected-to-pulse_length_pio_23_external_connection_export>), // pulse_length_pio_23_external_connection.export
		.pulse_length_pio_24_external_connection_export (<connected-to-pulse_length_pio_24_external_connection_export>), // pulse_length_pio_24_external_connection.export
		.pulse_length_pio_25_external_connection_export (<connected-to-pulse_length_pio_25_external_connection_export>), // pulse_length_pio_25_external_connection.export
		.pulse_length_pio_26_external_connection_export (<connected-to-pulse_length_pio_26_external_connection_export>), // pulse_length_pio_26_external_connection.export
		.pulse_length_pio_27_external_connection_export (<connected-to-pulse_length_pio_27_external_connection_export>), // pulse_length_pio_27_external_connection.export
		.pulse_length_pio_28_external_connection_export (<connected-to-pulse_length_pio_28_external_connection_export>), // pulse_length_pio_28_external_connection.export
		.pulse_length_pio_29_external_connection_export (<connected-to-pulse_length_pio_29_external_connection_export>), // pulse_length_pio_29_external_connection.export
		.pulse_length_pio_2_external_connection_export  (<connected-to-pulse_length_pio_2_external_connection_export>),  //  pulse_length_pio_2_external_connection.export
		.pulse_length_pio_30_external_connection_export (<connected-to-pulse_length_pio_30_external_connection_export>), // pulse_length_pio_30_external_connection.export
		.pulse_length_pio_31_external_connection_export (<connected-to-pulse_length_pio_31_external_connection_export>), // pulse_length_pio_31_external_connection.export
		.pulse_length_pio_32_external_connection_export (<connected-to-pulse_length_pio_32_external_connection_export>), // pulse_length_pio_32_external_connection.export
		.pulse_length_pio_33_external_connection_export (<connected-to-pulse_length_pio_33_external_connection_export>), // pulse_length_pio_33_external_connection.export
		.pulse_length_pio_34_external_connection_export (<connected-to-pulse_length_pio_34_external_connection_export>), // pulse_length_pio_34_external_connection.export
		.pulse_length_pio_35_external_connection_export (<connected-to-pulse_length_pio_35_external_connection_export>), // pulse_length_pio_35_external_connection.export
		.pulse_length_pio_3_external_connection_export  (<connected-to-pulse_length_pio_3_external_connection_export>),  //  pulse_length_pio_3_external_connection.export
		.pulse_length_pio_4_external_connection_export  (<connected-to-pulse_length_pio_4_external_connection_export>),  //  pulse_length_pio_4_external_connection.export
		.pulse_length_pio_5_external_connection_export  (<connected-to-pulse_length_pio_5_external_connection_export>),  //  pulse_length_pio_5_external_connection.export
		.pulse_length_pio_6_external_connection_export  (<connected-to-pulse_length_pio_6_external_connection_export>),  //  pulse_length_pio_6_external_connection.export
		.pulse_length_pio_7_external_connection_export  (<connected-to-pulse_length_pio_7_external_connection_export>),  //  pulse_length_pio_7_external_connection.export
		.pulse_length_pio_8_external_connection_export  (<connected-to-pulse_length_pio_8_external_connection_export>),  //  pulse_length_pio_8_external_connection.export
		.pulse_length_pio_9_external_connection_export  (<connected-to-pulse_length_pio_9_external_connection_export>),  //  pulse_length_pio_9_external_connection.export

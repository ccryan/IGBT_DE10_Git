#define EEP02_OFST		(0x02)
	...
	#define EEP02_Customer_EEPROM_OFST 		(0) // Customer non-volatile EEPROM. Can be used to store any customer information. Does not affect device operation
		...
		#define EEP02_Slave_Address_CLEAR_BASEMASK 		(0b0000000)
...
#define EEPROM_Address_BASEMASK		(0xFFFFFFFF)

#define EEPROM_Address_bit31to24_OFST		(24)
#define EEPROM_Address_bit23to16_OFST		(16)
#define EEPROM_Address_bit15to8_OFST		(8)
#define EEPROM_Address_bit7to0_OFST			(0)
